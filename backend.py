...
def improve_text_openai(text, improvement_type, custom_prompt=None):
    ...
    if custom_prompt:
        ...
        # Define prompts according to the improvement type (only for the default styles)
        prompts = {
            'claridad': f"Rewrite the following text in a clearer and more readable way. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the improved text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'formal': f"Rewrite the following text in a formal tone. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the rewritten text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'casual': f"Rewrite the following text in a casual and friendly tone. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the rewritten text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'academico': f"Rewrite the following text in an academic style. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the rewritten text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'narrativo': f"Improve the following narrative text or novel dialogue while preserving the literary style and narrative voice. Improve the flow, description and literary quality while keeping the essence of the text. Respond ONLY with the improved text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'academico_v2': f"Improve the following academic text making minimal changes to preserve the author's words. Use more precise vocabulary when necessary, improve the structure and remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Maintain the original style and vocabulary as much as possible. Respond ONLY with the improved text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'resumir': f"Create a concise summary of the following text. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the summary, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}",
            'expandir': f"Expand the following text by adding more details and relevant context. Remove any filler words or expressions typical of spoken language (mmm, ahhh, eh, um, etc.) and expressions of doubt when speaking or thinking aloud. Respond ONLY with the expanded text, without additional explanations. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n{text}"
        }
        
        prompt = prompts.get(improvement_type, f"Improve the following text. Preserve the original language of the following text exactly as it is. Do not translate or modify the language in any way. For example, if the text is in Spanish, keep it in Spanish; if it's in English, keep it in English:\n\n {text}")
